...
var style_EducacinNuncaasistiacentroeducativoformalHombres_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Nunca ha a");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_EducacinNuncaasistiacentroeducativoformalHombres_5_eval_expression(context) !== null) {
        labelText = String(exp_label_EducacinNuncaasistiacentroeducativoformalHombres_5_eval_expression(context));
    }
    if (value >= 0.000000 && value <= 207.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 207.200000 && value <= 388.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 388.200000 && value <= 692.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 692.800000 && value <= 1273.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1273.000000 && value <= 8579.000000) {
            style = [ new ol.style.Style({
