...
var style_AlfabetizacinNosabeleeroescribirMujeres_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_AlfabetizacinNosabeleeroescribirMujeres_10_eval_expression(context) !== null) {
        labelText = String(exp_label_AlfabetizacinNosabeleeroescribirMujeres_10_eval_expression(context));
    }
    if (value >= 0.000000 && value <= 425.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 425.600000 && value <= 766.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 766.000000 && value <= 1385.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1385.800000 && value <= 2562.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2562.000000 && value <= 17784.000000) {
            style = [ new ol.style.Style({
