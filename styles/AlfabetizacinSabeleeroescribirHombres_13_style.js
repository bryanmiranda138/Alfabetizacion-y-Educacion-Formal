...
var style_AlfabetizacinSabeleeroescribirHombres_13 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sabe leer");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_AlfabetizacinSabeleeroescribirHombres_13_eval_expression(context) !== null) {
        labelText = String(exp_label_AlfabetizacinSabeleeroescribirHombres_13_eval_expression(context));
    }
    if (value >= 0.000000 && value <= 1445.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1445.600000 && value <= 2610.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2610.000000 && value <= 4707.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4707.400000 && value <= 10301.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10301.600000 && value <= 135883.000000) {
            style = [ new ol.style.Style({
